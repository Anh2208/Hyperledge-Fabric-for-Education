...
const adminScheme = new mongoose.Schema({
    ...
    sdt: {
        ...
        validate: {
            ...
            message: 'Số điện thoại không hợp lệ, số điện thoại phải bắt đầu bằng 0 và có đúng 10 số.'
        }
    },
    date: {
        type: String,
...
adminScheme.statics.saltAndHashPassword = async function (password) { //mã hóa và hash mật khẩu
...
adminScheme.pre('save', async function (next) {//check password when save create student and save in db
    let user = this;
